...
//    
//    @Published
//    var slotsRect: [CGRect] = []
//    
//    //    @Published
//    var controller: SpineController
//    
//    var onSpineInitialized: SpineControllerCallback?
//    
//    //    @Published
...
//        
////定时调用的方法`onBeforeUpdateWorldTransforms`、`onAfterUpdateWorldTransforms`、
////        `onBeforePaint`、`onAfterPaint`
//        self.controller = SpineController(
////            onInitialized: { [weak self] controller in
////                guard let self  else { return }
////                
////                configSkeletonData(controller.drawable.skeletonData)
////                
////                self.onSpineInitialized?(controller)
////            },
////            onBeforeUpdateWorldTransforms: { [weak self] controller in
////                guard let self else { return }
//////                print("onBeforeUpdateWorldTransforms")
////            },
////            onAfterUpdateWorldTransforms: { [weak self] controller in
////                guard let self  else { return }
//////                print("onAfterUpdateWorldTransforms")
////            },
////            onBeforePaint: { [weak self] controller in
////                guard let self else { return }
//////                print("onBeforePaint")
////            },
////            onAfterPaint: { [weak self] controller in
////                guard let self  else { return }
//////                print("onAfterPaint")
////                //刷新骨骼信息
...
//        
////        skeleton?.setPosition(x: 10, y: 10)
...
//        //        }
//        if let slots = skeleton?.slots {
//            configSlots(slots: slots)
//        }
//        
...
////            print("bone.first:\(String(describing: bonesRect.first))")
//        } else {
...
//            let position = controller.fromSkeletonCoordinates(position: CGPointMake(CGFloat(slot.bone.worldX), CGFloat(slot.bone.worldY)))
//            let rect = CGRect(x: position.x,
//                              y: position.y,
//                              width: 5,
//                              height: 5)
////            let rect = CGRect(x: Int(slot.bone.worldX),
////                              y: Int(slot.bone.worldY),
////                              width: 5,
////                              height: 5)
...
//        self.controller.drawable?.skeleton
//    }
//    
...
//        self.controller.drawable?.animationState
//    }
//}
//
