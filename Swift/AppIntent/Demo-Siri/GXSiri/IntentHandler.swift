...
class IntentHandler: INExtension, INGetCarLockStatusIntentHandling, INStartWorkoutIntentHandling,INEndWorkoutIntentHandling{
    ...
    override func handler(for intent: INIntent) -> Any {
        ...
        print("handler(for intent: \(intent.description)")
        return self
    }
