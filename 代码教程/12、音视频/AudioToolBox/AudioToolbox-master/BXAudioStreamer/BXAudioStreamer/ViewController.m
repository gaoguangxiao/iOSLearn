                                         ...
                                         AudioFileStreamPropertyFlags *	ioFlags)
{
    ...
    [self audioFileStreamPropertyListenerProc:inClientData 
...
-(void)audioFileStreamPropertyListenerProc:(void *)inClientData
                         inAudioFileStream:(AudioFileStreamID)inAudioFileStream
                              inPropertyID:(AudioFileStreamPropertyID)inPropertyID ioFlags:(AudioFileStreamPropertyFlags *)ioFlags
{
...
- (void)viewDidLoad {
    ...
    OSStatus osstatus = AudioFileStreamOpen((__bridge void * _Nullable)(self), 
...
//    NSString *wavString = @"http://baxiang.qiniudn.com/VoiceOriginFile.wav";// wav文件
    NSString *mp3String = @"http://localhost:8081/static/music-Loop.mp3";// mp3文件
