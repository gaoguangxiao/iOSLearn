...
//		const t = window.nativeBridge.postMessage(message);
//        JSBridgeEvent.fireEvent(t, "add");
        
//         console.log('t:', t);
//        JSBridgeEvent.fireEvent(t, '32');
         //        var t = window.webkit.messageHandlers.JSBridge.postMessage(message);
         //
         //        console.log(ios14PromiseTest);
         *
